...
const slides = [
    {
        id: 1,
        title: 'خوش آمدید به سامانه جرثقیل',
        subtitle: 'اجاره و درخواست پروژه‌های ساختمانی',
        description: 'بهترین راهکار برای مدیریت تجهیزات و پروژه‌های ساختمانی',
        icon: Sparkles,
        colors: ['rgba(255, 0, 0, 0.86)', 'rgba(255, 105, 25, 0.6)'],
    },
    {
        id: 2,
        title: 'اجاره جرثقیل',
        subtitle: 'بدون دردسر و پیچیدگی',
        description: 'بهترین قیمت و سریع‌ترین خدمات برای اجاره جرثقیل',
        icon: Zap,
        colors: ['rgba(76, 175, 80, 0.8)', 'rgba(56, 142, 60, 0.6)'],
    },
    {
        id: 3,
        title: 'درخواست پروژه',
        subtitle: 'مدیریت آسان',
        description: 'پیگیری پروژه‌های خود به سهولت و سرعت',
        icon: Heart,
        colors: ['rgba(63, 81, 181, 0.85)', 'rgba(48, 63, 159, 0.65)'],
    },
];
